		 ...
		 <form action="{{ url('cart/product/add/'.$product->id) }}" method="post">
          ...
          <div class="row">
          	...
          	<div class="form-group">
          		<label for="exampleFormControlSelect1">色</label>
...
<div class="product_price">￥{{ number_format($product->selling_price) }}<span> </div>
      @else
<div class="product_price">￥{{ number_format($product->discount_price) }}<span>${{ number_format($product->selling_price) }}</span></div>
      @endif


								<div class="button_container">
									<button type="submit" class="button cart_button">カートに追加する</button>
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item">
    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">商品詳細</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">商品レビュー</a>
  </li>
</ul>
