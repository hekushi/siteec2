        ...
        <div class="container">
            <div class="row">
                <div class="col d-flex flex-lg-row flex-column align-items-center justify-content-start">
                    ...
                    <div class="deals">
                        <div class="deals_title">今週のお買い得情報</div>
         ...
         @endif
            ...
            <div class="deals_timer d-flex flex-row align-items-center justify-content-start">
                <div class="deals_timer_title_container">
                    <div class="deals_timer_title">お急ぎください</div>
                    <div class="deals_timer_subtitle">開催終了日:</div>
                </div>
...
<div class="product_name"><div><a href="{{ url('product/details/'.$row->id.'/'.$row->product_name) }}">{{ $row->product_name }}</a></div></div>
     ...
     <button id="{{ $row->id }}" class="product_cart_button addcart" data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)">カートに入れる</button>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="popular_categories_content">
                        <div class="popular_categories_title">人気のカテゴリー</div>
                        <div class="popular_categories_slider_nav">
                            <div class="popular_categories_prev popular_categories_nav"><i class="fas fa-angle-left ml-auto"></i></div>
                            <div class="popular_categories_next popular_categories_nav"><i class="fas fa-angle-right ml-auto"></i></div>
                        </div>
                        <div class="popular_categories_link"><a href="#">カタログを見る</a></div>
                    </div>
                </div>
            ...
            <div class="row fill_height">
                <div class="col-lg-4 col-md-6 fill_height">
                    <div class="banner_2_content">
                        ...
                        <div class="button banner_2_button"><a href="{{ url('product/details/'.$row->id.'/'.$row->product_name) }}">チェック</a></div>
                    </div>
...
<div class="product_price discount">￥{{ $row->discount_price }}<span>￥{{ $row->selling_price }}</span></div>
      ...
      <button id="{{ $row->id }}" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)">購入する</button>
                        </div>
                    </div>
                    <ul class="trends_marks">
                       
                        <li class="trends_mark trends_new">Get</li>
                    </ul>
                     <button class="addwishlist" data-id="{{ $row->id }}" >
                ...
                <div class="col">
                    <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                        <div class="newsletter_title_container">
                            ...
                            <div class="newsletter_title">ニュースレターへの登録はこちら</div>
                            <div class="newsletter_text"><p>初回のお買い物で20％のクーポンをプレゼント</p></div>
                        </div>
                        <div class="newsletter_content clearfix">
       <form action="{{ route('store.newslater') }}" method="post" class="newsletter_form">
        @csrf
               <input type="email" class="newsletter_input" required="required" placeholder="メールアドレスを入力してください" name="email">
            <button class="newsletter_button" type="submit">申し込み</button>
                            </form>
                            <div class="newsletter_unsubscribe_link"><a href="#">配信停止</a></div>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLavel">商品情報 クイックビュー</h5>
...
<div class="col-md-4">
  ...
  <li class="list-group-item">カテゴリー: <span id="pcat"></span></li>
  <li class="list-group-item">サブカテゴリー: <span id="psub"></span></li>
  <li class="list-group-item">ブランド:<span id="pbrand"></span> </li>
  <li class="list-group-item">在庫数: <span class="badge" style="background: green;color: white;" > 購入可能</span> </li>
</ul>
    ...
    <input type="hidden" name="product_id" id="product_id">
         ...
         <div class="form-group">
            <label for="exampleInputcolor">色</label>
 ...
 <div class="form-group">
            <label for="exampleInputcolor">サイズ</label>
