...
<div class="col-lg-4">
 ...
 <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">画像1 ( Main Thumbnali): <span class="tx-danger">*</span></label>
          ...
          <img src="#" id="one">
               ...
               <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">画像2: <span class="tx-danger">*</span></label>
                 <label class="custom-file">
 ...
 <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">画像3: <span class="tx-danger">*</span></label>
                 <label class="custom-file">
...
<br><br>
            ...
            <div class="form-layout-footer">
              <button class="btn btn-info mg-r-5">決済</button>
